      ...
      <section className="relative pt-24 pb-20 md:pt-32 md:pb-32 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center relative z-10">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-accent-light/50 border border-primary-accent-light text-primary-accent-dark text-sm font-semibold mb-6 w-max shadow-sm backdrop-blur-sm"
            >
            ...
            <motion.h1
              variants={fadeUp}
              className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-text-primary leading-[1.1] mb-6"
            >
            ...
            >
              Protect your corporate expenditures with AI-powered monitoring
              algorithms. Instantly identify rogue spending, optimize financial
              recovery pools, and secure your bottom line natively.
            </motion.p>
            ...
            >
              <Link
                href="/dashboard"
                className="px-8 py-4 rounded-xl bg-linear-to-r from-primary-accent to-primary-accent-dark text-surface font-bold text-lg hover:shadow-lg hover:shadow-primary-accent/30 transition-all flex items-center justify-center gap-2 group hover:scale-[1.02] active:scale-[0.98]"
              >
                Access Dashboard
              ...
              <Link
                href="/import"
                className="px-8 py-4 rounded-xl cursor-pointer bg-white border border-slate-200 text-slate-800 font-bold text-lg hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm flex items-center justify-center"
              >
                Add Expenses
              </Link>
            </motion.div>
          ...
          >
            <div className="absolute inset-0 bg-linear-to-tr from-blue-500/20 to-indigo-500/20 rounded-3xl blur-2xl transform -rotate-6" />
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-around gap-8 text-center divide-y sm:divide-y-0 sm:divide-x divide-slate-200">
            {[
              ...
              >
                <div className="text-4xl font-extrabold text-primary-accent mb-2">
                  {stat.value}
                </div>
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600">
              We leverage multi-layered algorithmic heuristics to flag bad
              actors before financial closure occurs.
            </p>
          </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1200px] mx-auto">
          <div className="relative rounded-[2.5rem] bg-slate-900 overflow-hidden shadow-2xl">
            <div className="absolute inset-0 bg-linear-to-r from-blue-900/40 to-indigo-900/40 mix-blend-overlay" />
            ...
            <div className="relative z-10 px-8 py-16 md:py-20 md:px-16 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="max-w-xl text-center md:text-left">
                <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                  Ready to secure your expenditure?
                </h2>
                <p className="text-blue-100 text-lg sm:text-xl opacity-90 mb-0">
                  Join hundreds of financial control teams leveraging
                  SpendShield today.
                </p>
              </div>
              <div className="shrink-0 flex gap-4 w-full md:w-auto">
                <Link
                  href="/dashboard"
                  className="w-full md:w-auto px-8 py-4 rounded-xl bg-white text-slate-900 font-bold text-lg hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all flex items-center justify-center gap-2 group"
                >
                  Open Engine
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
