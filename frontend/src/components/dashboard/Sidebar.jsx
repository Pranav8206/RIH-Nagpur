        ...
        <>
            ...
            <div className="hidden md:flex flex-col w-20 bg-surface border-r border-border-light min-h-screen sticky top-0 md:h-screen">
                <div className="h-16 flex items-center justify-center border-b border-border-light">
                    <Link href="/" className="flex items-center justify-center w-10 h-10 bg-primary-accent rounded-lg shadow-sm hover:scale-105 transition-transform">
                    ...
                    {navigation.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className="text-[10px] sm:text-[9px] font-medium text-center leading-tight tracking-wide">{item.name}</span>
                            </Link>
                        )
                    })}
                </div>
            ...
            >
                ...
                <div className="p-4 border-t border-border-light space-y-1">
                    <button
                        className="flex w-full items-center space-x-3 px-4 py-3 rounded-xl font-medium text-text-secondary hover:bg-surface-hover hover:text-text-primary transition-colors text-sm"
                    >
