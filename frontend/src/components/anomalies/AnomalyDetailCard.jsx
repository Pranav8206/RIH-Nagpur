        ...
        <div className="bg-surface rounded-xl border border-border-light shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-border-light bg-surface-hover flex justify-between items-center">
               <h2 className="text-lg font-bold text-text-primary tracking-tight flex items-center">
                  <Target className="w-5 h-5 mr-2 text-primary-accent" /> Matrix Fingerprint
               </h2>
               <div className={`px-2.5 py-1 rounded-lg border text-xs font-bold uppercase tracking-widest ${
                   anomaly.severity === 'High' ? 'bg-error/10 text-error border-red-200' :
            ...
            <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 divide-x divide-gray-100">
                    ...
                    <div className="space-y-5 pr-4">
                        ...
                        <div>
                            <div className="text-xs font-medium text-text-tertiary mb-0.5">Vendor Target</div>
                            <div className="text-xl font-bold text-text-primary">{transaction.vendor_name}</div>
                        </div>
                        ...
                        <div className="flex space-x-8">
                             ...
                             <div>
                                 ...
                                 <div className="text-sm font-semibold text-text-secondary mt-2">{formatDate(transaction.date)}</div>
                             </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 bg-surface-hover p-3 rounded-lg border border-border-light">
                             <div>
                                 ...
                                 <div className="text-xs font-mono text-text-secondary font-semibold">{transaction.invoice_number}</div>
                             </div>
                             <div>
                                 <div className="text-[10px] font-bold text-text-tertiary uppercase tracking-wider mb-1 flex items-center">
                                    <CreditCard className="w-3 h-3 mr-1" /> Method
                                 </div>
                                 <div className="text-xs font-semibold text-text-secondary">{transaction.payment_method}</div>
                             </div>
                        </div>
                    </div>
                    ...
                    <div className="pl-8 space-y-6">
                        ...
                        <div className="bg-surface p-4 rounded-xl border border-border-light shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                             <div className="flex justify-between items-end mb-2">
                                <div className="text-xs font-bold text-text-tertiary uppercase tracking-wider">Engine Score</div>
                                <div className="text-lg font-mono font-bold text-error">{anomaly.anomaly_score.toFixed(2)}</div>
                             </div>
                        ...
                        <div>
                             <div className="text-[10px] font-bold text-text-tertiary uppercase tracking-widest mb-1.5">Algorithmic Method</div>
                        ...
                        <div>
                             <div className="text-[10px] font-bold text-text-tertiary uppercase tracking-widest mb-1.5">Node Log</div>
