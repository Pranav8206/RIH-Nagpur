...
export default function AnomalyFilters({ currentFilters, onFilterChange }) {
    return (
        <div className="p-4 border-b border-border-light bg-gray-50/80 flex flex-col sm:flex-row items-center gap-4 shadow-sm z-10 w-full relative">
            ...
            <select 
               className="text-sm form-select rounded-lg border border-border-light outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 py-2.5 pl-3 pr-8 shadow-sm flex-1 sm:flex-none min-w-[150px] bg-surface cursor-pointer tracking-wide appearance-none bg-no-repeat"
            ...
            <select 
               className="text-sm form-select rounded-lg border border-border-light outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 py-2.5 pl-3 pr-8 shadow-sm flex-1 sm:flex-none min-w-[150px] bg-surface cursor-pointer tracking-wide appearance-none"
