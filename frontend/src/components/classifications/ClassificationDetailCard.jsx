        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
               <h2 className="text-lg font-bold text-slate-800 tracking-tight flex items-center">
                  <Network className="w-5 h-5 mr-2 text-indigo-500" /> Validation Node Overview
               </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 divide-x divide-gray-100">
                    ...
                    <div className="space-y-6 pr-4">
                        <div>
                            ...
                            <div className="text-xl font-bold tracking-tight text-slate-800">{classification.leakage_type}</div>
                        </div>

                        <div>
                            <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 flex justify-between max-w-[80%]">
                               <span>Algorithm Accuracy Score</span>
                               <span className="text-indigo-600 font-mono">{(classification.confidence_score * 100).toFixed(1)}%</span>
                            </div>
                            <div className="h-2 w-[80%] bg-gray-100 rounded-full overflow-hidden shadow-inner border border-gray-200/50">
                                <div className="h-full bg-gradient-to-r from-indigo-400 to-indigo-600 rounded-full transition-all duration-1000" style={{ width: `${classification.confidence_score * 100}%` }}></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pl-8 space-y-6">
                         <div>
                            ...
                            <p className="text-sm font-medium text-slate-600 bg-gray-50 border border-gray-100 p-4 rounded-xl leading-relaxed tracking-wide shadow-sm">
                                {classification.root_cause || "System derived flag missing explicit root strings."}
                            </p>
                         </div>
