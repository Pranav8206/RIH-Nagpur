...
export default function ClassificationFilters({ currentFilters, onFilterChange }) {
    return (
        <div className="p-4 border-b border-gray-100 bg-gray-50/80 flex flex-col sm:flex-row items-center gap-4 shadow-sm z-10 w-full relative content-start">
            ...
            <select 
               className="text-sm rounded-lg border border-gray-200 outline-none focus:ring-2 focus:ring-indigo-100 focus:border-indigo-300 py-2.5 pl-3 pr-8 shadow-sm flex-1 sm:flex-none min-w-[220px] bg-white cursor-pointer tracking-wide appearance-none"
            ...
            <select 
               className="text-sm rounded-lg border border-gray-200 outline-none focus:ring-2 focus:ring-indigo-100 focus:border-indigo-300 py-2.5 pl-3 pr-8 shadow-sm flex-1 sm:flex-none min-w-[150px] bg-white cursor-pointer tracking-wide appearance-none"
